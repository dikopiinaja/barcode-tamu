<div class="container d-flex justify-content-center">
	<div class="card col-12 card-primary card-outline">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><?= $usr->username?></td>
						<td><?= $usr->password?></td>
						<td><?= $usr->nama_petugas?></td>
						<td><?= $usr->alamat?></td>
						<td style="text-align:center">
							<a href="<?= base_url('admin/editBagian')?>/<?php echo $usr->id_user ?>" class="btn btn-sm btn-warning">Edit</a>
							<a href="#hapus_bagian" data-toggle="modal"
										onclick="$('#hapus_bagian #formDelete').attr('action', '<?=site_url('admin/delete_bagian/'). $usr->id_user?>')"
